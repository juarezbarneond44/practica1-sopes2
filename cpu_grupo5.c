...
int iniciar(void){ //modulo de inicio
	proc_create("cpu_grupo5", 0, NULL, &operaciones);
	printk(KERN_INFO "%s", "Hola mundo, somos el grupo 5 y este es el monitor del cpu en el sistema");
...
void salir(void){
	...
	printk(KERN_INFO "%s","Sayonara mundo, somos el grupo 5 y este fue el monitor de cpu");
